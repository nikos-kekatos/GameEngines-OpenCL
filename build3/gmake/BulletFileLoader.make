...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/BulletFileLoader
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libBulletFileLoader_gmake_x64_release.a
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/BulletFileLoader
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libBulletFileLoader_gmake_x64_debug.a
...
clean:
	@echo Cleaning BulletFileLoader
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
