...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/pybullet
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libpybullet_gmake_x64_debug.dylib
  DEFINES   += -DBT_USE_DOUBLE_PRECISION -D_DEBUG=1 -DPHYSICS_IN_PROCESS_EXAMPLE_BROWSER -DBT_ENABLE_ENET -D_DARWIN -DBT_ENABLE_CLSOCKET
  INCLUDES  += -I../../src -I../../examples -I../../examples/ThirdPartyLibs -I../../examples/ThirdPartyLibs/glad -I../../examples/pybullet -I../../examples/ThirdPartyLibs/enet/include -I../../examples/ThirdPartyLibs/clsocket/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/glad.o: ../../examples/ThirdPartyLibs/glad/glad.c
	@echo $(notdir $<)
...
$(OBJDIR)/PhysicsClientTCP_C_API.o: ../../examples/SharedMemory/PhysicsClientTCP_C_API.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/pybullet.o: ../../examples/pybullet/pybullet.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
