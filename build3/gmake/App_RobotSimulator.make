...
ifeq ($(config),debug64)
  ...
  DEFINES   += -DBT_USE_DOUBLE_PRECISION -D_DEBUG=1 -DB3_USE_ROBOTSIM_GUI -DPHYSICS_IN_PROCESS_EXAMPLE_BROWSER -DBT_ENABLE_ENET -D_DARWIN -DBT_ENABLE_CLSOCKET
  INCLUDES  += -I../../src -I../../examples -I../../examples/ThirdPartyLibs -I../../examples/ThirdPartyLibs/glad -I../../examples/RobotSimulator -I../../examples/ThirdPartyLibs/enet/include -I../../examples/ThirdPartyLibs/clsocket/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/b3RobotSimulatorClientAPI.o: ../../examples/RobotSimulator/b3RobotSimulatorClientAPI.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/b3RobotSimulatorClientAPI_NoGUI.o: ../../examples/RobotSimulator/b3RobotSimulatorClientAPI_NoGUI.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
